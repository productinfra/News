    ...
    <div class="content">
      ...
      <div class="center">
        ...
        <div class="c-l-header">
          ...
          <div class="search">
            ...
            <input type="text" class="s-input" v-model="keyword" @keydown.enter="searchPost" placeholder="Search" />
          </div>
          <div class="publish-btn" @click="goPublish">Publish</div>
        </div>
        <ul class="c-l-list">
      ...
      <div class="right">
        ...
        <div class="github-project-card-container">
          <TrendingNewsCard language="all"></TrendingNewsCard>
        </div>
      </div>
    </div>
  </div>
      ...
      this.$axios({
        ...
        .then(response => {
          if (response.code == 1000) {
            ...
            Vue.prototype.$message.error('You can only vote once')
          } else if (response.code == 1010) {
            Vue.prototype.$message.error('The voting time has passed')
          } else {
            console.log(response.msg);
